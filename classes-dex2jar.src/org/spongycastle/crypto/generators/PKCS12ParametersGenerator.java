  ...
  extends PBEParametersGenerator
{
  ...
  public PKCS12ParametersGenerator(Digest paramDigest)
  {
    ...
    {
      this.aNj = paramDigest.iJ();
      this.aNk = ((ExtendedDigest)paramDigest).iM();
      return;
    }
    throw new IllegalArgumentException("Digest " + paramDigest.iG() + " unsupported");
  }
  ...
  private byte[] ᐢ(int paramInt1, int paramInt2)
  {
    ...
    byte[] arrayOfByte2 = new byte[this.aNj];
    paramInt1 = 1;
    while (paramInt1 <= i)
    {
      ...
      {
        arrayOfByte1[paramInt2] = arrayOfByte2[(paramInt2 % arrayOfByte2.length)];
        paramInt2 += 1;
      }
      paramInt2 = 0;
