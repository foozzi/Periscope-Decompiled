  ...
  public void ⁱ(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramArrayOfByte[j] = this.aMt[(this.aMt[(this.aMt[(this.aMu & 0xFF)] & 0xFF)] + 1 & 0xFF)];
