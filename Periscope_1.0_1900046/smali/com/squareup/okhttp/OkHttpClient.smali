...
.field private final interceptors:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<Lcom/squareup/okhttp/Interceptor;>;"
        }
    .end annotation
.end field
...
.method final copyWithDefaults()Lcom/squareup/okhttp/OkHttpClient;
    ...
    invoke-direct {v1, p0}, Lcom/squareup/okhttp/OkHttpClient;-><init>(Lcom/squareup/okhttp/OkHttpClient;)V

    .line 589
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->proxySelector:Ljava/net/ProxySelector;
    ...
    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->proxySelector:Ljava/net/ProxySelector;

    .line 592
    :cond_0
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->cookieHandler:Ljava/net/CookieHandler;
    ...
    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->cookieHandler:Ljava/net/CookieHandler;

    .line 595
    :cond_1
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->socketFactory:Ljavax/net/SocketFactory;
    ...
    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->socketFactory:Ljavax/net/SocketFactory;

    .line 598
    :cond_2
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->sslSocketFactory:Ljavax/net/ssl/SSLSocketFactory;
    ...
    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->sslSocketFactory:Ljavax/net/ssl/SSLSocketFactory;

    .line 601
    :cond_3
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->hostnameVerifier:Ljavax/net/ssl/HostnameVerifier;
    ...
    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->hostnameVerifier:Ljavax/net/ssl/HostnameVerifier;

    .line 604
    :cond_4
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->certificatePinner:Lcom/squareup/okhttp/CertificatePinner;

    if-nez v0, :cond_5

    .line 605
    sget-object v0, Lcom/squareup/okhttp/CertificatePinner;->DEFAULT:Lcom/squareup/okhttp/CertificatePinner;

    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->certificatePinner:Lcom/squareup/okhttp/CertificatePinner;

    .line 607
    :cond_5
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->authenticator:Lcom/squareup/okhttp/Authenticator;

    if-nez v0, :cond_6

    .line 608
    sget-object v0, Lcom/squareup/okhttp/internal/http/AuthenticatorAdapter;->INSTANCE:Lcom/squareup/okhttp/Authenticator;

    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->authenticator:Lcom/squareup/okhttp/Authenticator;

    .line 610
    :cond_6
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->connectionPool:Lcom/squareup/okhttp/ConnectionPool;
    ...
    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->connectionPool:Lcom/squareup/okhttp/ConnectionPool;

    .line 613
    :cond_7
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->protocols:Ljava/util/List;

    if-nez v0, :cond_8

    .line 614
    sget-object v0, Lcom/squareup/okhttp/OkHttpClient;->DEFAULT_PROTOCOLS:Ljava/util/List;

    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->protocols:Ljava/util/List;

    .line 616
    :cond_8
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->connectionSpecs:Ljava/util/List;

    if-nez v0, :cond_9

    .line 617
    sget-object v0, Lcom/squareup/okhttp/OkHttpClient;->DEFAULT_CONNECTION_SPECS:Ljava/util/List;

    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->connectionSpecs:Ljava/util/List;

    .line 619
    :cond_9
    iget-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->network:Lcom/squareup/okhttp/internal/Network;

    if-nez v0, :cond_a

    .line 620
    sget-object v0, Lcom/squareup/okhttp/internal/Network;->DEFAULT:Lcom/squareup/okhttp/internal/Network;

    iput-object v0, v1, Lcom/squareup/okhttp/OkHttpClient;->network:Lcom/squareup/okhttp/internal/Network;
...
.method public final setConnectionSpecs(Ljava/util/List;)Lcom/squareup/okhttp/OkHttpClient;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/List<Lcom/squareup/okhttp/ConnectionSpec;>;)Lcom/squareup/okhttp/OkHttpClient;"
        }
    .end annotation
...
.method public final setProtocols(Ljava/util/List;)Lcom/squareup/okhttp/OkHttpClient;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Ljava/util/List<Lcom/squareup/okhttp/Protocol;>;)Lcom/squareup/okhttp/OkHttpClient;"
        }
    .end annotation
