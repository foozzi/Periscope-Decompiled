...
# instance fields
.field private ᐥ:Landroid/app/Notification$Builder;

.field private ᑋ:Landroid/os/Bundle;

.field private ᴊ:Ljava/util/List;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v0, p0, Lo/ˮ$if;->ᴊ:Ljava/util/List;
    ...
    iput-object v0, p0, Lo/ˮ$if;->ᐥ:Landroid/app/Notification$Builder;
    ...
    iput-object v0, p0, Lo/ˮ$if;->ᑋ:Landroid/os/Bundle;

    .line 72
    if-eqz p20, :cond_4

    .line 73
    iget-object v0, p0, Lo/ˮ$if;->ᑋ:Landroid/os/Bundle;
...
.method public build()Landroid/app/Notification;
    ...
    .line 106
    iget-object v0, p0, Lo/ˮ$if;->ᴊ:Ljava/util/List;

    invoke-static {v0}, Lo/ˡ;->ˋ(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 113
    :cond_0
    iget-object v0, p0, Lo/ˮ$if;->ᐥ:Landroid/app/Notification$Builder;

    iget-object v1, p0, Lo/ˮ$if;->ᑋ:Landroid/os/Bundle;
...
.method public ˊ(Lo/ʳ$if;)V
    .locals 2

    .line 97
    iget-object v0, p0, Lo/ˮ$if;->ᴊ:Ljava/util/List;

    iget-object v1, p0, Lo/ˮ$if;->ᐥ:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Lo/ˡ;->ˋ(Landroid/app/Notification$Builder;Lo/ʳ$if;)Landroid/os/Bundle;
...
.method public ᵢ()Landroid/app/Notification$Builder;
    .locals 1
