...
.method public static ˏ(Ljava/security/cert/X509CertSelector;)Lorg/spongycastle/x509/X509CertStoreSelector;
    .locals 5
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setAuthorityKeyIdentifier([B)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setBasicConstraints(I)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setCertificate(Ljava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setCertificateValid(Ljava/util/Date;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setMatchAllSubjectAltNames(Z)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setPathToNames(Ljava/util/Collection;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setExtendedKeyUsage(Ljava/util/Set;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setNameConstraints([B)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setPolicy(Ljava/util/Set;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setSubjectPublicKeyAlgID(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setSubjectAlternativeNames(Ljava/util/Collection;)V
    :try_end_0
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setIssuer(Ljavax/security/auth/x500/X500Principal;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setKeyUsage([Z)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setPrivateKeyValid(Ljava/util/Date;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setSerialNumber(Ljava/math/BigInteger;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setSubject(Ljavax/security/auth/x500/X500Principal;)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setSubjectKeyIdentifier([B)V
    ...
    invoke-virtual {v3, v0}, Lorg/spongycastle/x509/X509CertStoreSelector;->setSubjectPublicKey(Ljava/security/PublicKey;)V
...
.method public match(Ljava/security/cert/Certificate;)Z
    ...
    .line 36
    invoke-virtual {p0, p1}, Lorg/spongycastle/x509/X509CertStoreSelector;->ɨ(Ljava/lang/Object;)Z
