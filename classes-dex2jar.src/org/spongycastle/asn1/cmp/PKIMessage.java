...
public class PKIMessage
  extends ASN1Object
{
  private PKIHeader adD;
  private PKIBody adE;
  private DERBitString adF;
  ...
  public ASN1Primitive ez()
  {
    ...
    localASN1EncodableVector.ˊ(this.adD);
    localASN1EncodableVector.ˊ(this.adE);
    ˊ(localASN1EncodableVector, 0, this.adF);
    ˊ(localASN1EncodableVector, 1, this.adG);
