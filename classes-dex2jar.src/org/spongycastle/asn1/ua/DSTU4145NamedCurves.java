...
public class DSTU4145NamedCurves
{
  ...
  public static final ECDomainParameters[] avT;
  static final ASN1ObjectIdentifier[] avU;
  static final String avV;
  
  static
  {
    ONE = BigInteger.valueOf(1L);
    avT = new ECDomainParameters[10];
    avU = new ASN1ObjectIdentifier[10];
    avV = UAObjectIdentifiers.awc.getId() + ".2.";
    ...
    ECPoint localECPoint1 = arrayOfF2m[0].ᐝ(new BigInteger("2E2F85F5DD74CE983A5C4237229DAF8A3F35823BE", 16), new BigInteger("3826F008A8C51D7B95284D9D03FF0E00CE2CD723A", 16));
    ECPoint localECPoint2 = arrayOfF2m[1].ᐝ(new BigInteger("7A1F6653786A68192803910A3D30B2A2018B21CD54", 16), new BigInteger("5F49EB26781C0EC6B8909156D98ED435E45FD59918", 16));
    ECPoint localECPoint3 = arrayOfF2m[2].ᐝ(new BigInteger("4D41A619BCC6EADF0448FA22FAD567A9181D37389CA", 16), new BigInteger("10B51CC12849B234C75E6DD2028BF7FF5C1CE0D991A1", 16));
    ECPoint localECPoint4 = arrayOfF2m[3].ᐝ(new BigInteger("6BA06FE51464B2BD26DC57F48819BA9954667022C7D03", 16), new BigInteger("25FBC363582DCEC065080CA8287AAFF09788A66DC3A9E", 16));
    ECPoint localECPoint5 = arrayOfF2m[4].ᐝ(new BigInteger("714114B762F2FF4A7912A6D2AC58B9B5C2FCFE76DAEB7129", 16), new BigInteger("29C41E568B77C617EFE5902F11DB96FA9613CD8D03DB08DA", 16));
    ECPoint localECPoint6 = arrayOfF2m[5].ᐝ(new BigInteger("3FCDA526B6CDF83BA1118DF35B3C31761D3545F32728D003EEB25EFE96", 16), new BigInteger("9CA8B57A934C54DEEDA9E54A7BBAD95E3B2E91C54D32BE0B9DF96D8D35", 16));
    ECPoint localECPoint7 = arrayOfF2m[6].ᐝ(new BigInteger("02A29EF207D0E9B6C55CD260B306C7E007AC491CA1B10C62334A9E8DCD8D20FB7", 16), new BigInteger("10686D41FF744D4449FCCF6D8EEA03102E6812C93A9D60B978B702CF156D814EF", 16));
    ECPoint localECPoint8 = arrayOfF2m[7].ᐝ(new BigInteger("216EE8B189D291A0224984C1E92F1D16BF75CCD825A087A239B276D3167743C52C02D6E7232AA", 16), new BigInteger("5D9306BACD22B7FAEB09D2E049C6E2866C5D1677762A8F2F2DC9A11C7F7BE8340AB2237C7F2A0", 16));
    ECPoint localECPoint9 = arrayOfF2m[8].ᐝ(new BigInteger("324A6EDDD512F08C49A99AE0D3F961197A76413E7BE81A400CA681E09639B5FE12E59A109F78BF4A373541B3B9A1", 16), new BigInteger("1AB597A5B4477F59E39539007C7F977D1A567B92B043A49C6B61984C3FE3481AAF454CD41BA1F051626442B3C10", 16));
    ECPoint localECPoint10 = arrayOfF2m[9].ᐝ(new BigInteger("1A62BA79D98133A16BBAE7ED9A8E03C32E0824D57AEF72F88986874E5AAE49C27BED49A2A95058068426C2171E99FD3B43C5947C857D", 16), new BigInteger("70B5E1E14031C1F70BBEFE96BDDE66F451754B4CA5F48DA241F331AA396B8D1839A855C1769B1EA14BA53308B5E2723724E090E02DB9", 16));
    int i = 0;
    while (i < avT.length)
    {
      avT[i] = new ECDomainParameters(arrayOfF2m[i], new ECPoint[] { localECPoint1, localECPoint2, localECPoint3, localECPoint4, localECPoint5, localECPoint6, localECPoint7, localECPoint8, localECPoint9, localECPoint10 }[i], arrayOfBigInteger1[i], arrayOfBigInteger2[i]);
      i += 1;
    }
    i = 0;
    while (i < avU.length)
    {
      avU[i] = new ASN1ObjectIdentifier(avV + i);
      i += 1;
    }
  }
  
  public static ECDomainParameters ˋ(ASN1ObjectIdentifier paramASN1ObjectIdentifier)
  {
    paramASN1ObjectIdentifier = paramASN1ObjectIdentifier.getId();
    if (paramASN1ObjectIdentifier.startsWith(avV))
    {
      int i = Integer.parseInt(paramASN1ObjectIdentifier.substring(paramASN1ObjectIdentifier.length() - 1));
      return avT[i];
    }
    return null;
  }
 ...
 * Qualified Name:     org.spongycastle.asn1.ua.DSTU4145NamedCurves
