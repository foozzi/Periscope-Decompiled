  ...
  implements ss
{
  ...
  static
  {
    ...
    Qt = (String[])((Collection)localObject).toArray(new String[((Collection)localObject).size()]);
  }
  
  public mp(Context paramContext)
  {
    this.appContext = paramContext.getApplicationContext();
  }
  
  public InputStream օ()
  {
    return this.appContext.getResources().openRawResource(me.aux.tw__cacerts);
  }
