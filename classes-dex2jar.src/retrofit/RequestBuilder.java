  ...
  implements RequestInterceptor.RequestFacade
{
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject1 == null)
        {
          ...
          localObject2 = paramString1;
          str = paramString2;
          this.queryParams = ((StringBuilder)localObject3);
        }
        localObject2 = paramString1;
        str = paramString2;
        if (((StringBuilder)localObject3).length() > 0)
        {
          ...
          localObject2 = localObject1;
          str = paramString1;
          ((StringBuilder)localObject3).append((String)localObject1).append('=').append(paramString1);
          return;
        }
      }
      catch (UnsupportedEncodingException paramString1)
      {
        throw new RuntimeException("Unable to convert query parameter \"" + (String)localObject2 + "\" value to UTF-8: " + str, paramString1);
      }
      char c = '?';
    }
  }
  ...
  void setArguments(Object[] paramArrayOfObject)
  {
    ...
    while (j < i)
    {
      ...
      Object localObject2 = this.paramAnnotations[j];
      Object localObject3 = ((Annotation)localObject2).annotationType();
      ...
      else if (localObject3 == EncodedPath.class)
      {
      ...
      else
      {
        ...
        else
        {
          ...
          else if (localObject3 == Body.class)
          {
            if (localObject1 == null) {
