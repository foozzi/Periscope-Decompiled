  ...
  implements EncodableDigest
{
  ...
  private void ˊ(SHA224Digest paramSHA224Digest)
  {
    super.ˊ(paramSHA224Digest);
    this.aGA = paramSHA224Digest.aGA;
    this.aGB = paramSHA224Digest.aGB;
    this.aGC = paramSHA224Digest.aGC;
    this.aGD = paramSHA224Digest.aGD;
    this.aGI = paramSHA224Digest.aGI;
    this.aGJ = paramSHA224Digest.aGJ;
    this.aGK = paramSHA224Digest.aGK;
    this.aGL = paramSHA224Digest.aGL;
    System.arraycopy(paramSHA224Digest.aGE, 0, this.aGE, 0, paramSHA224Digest.aGE.length);
    this.aGw = paramSHA224Digest.aGw;
  }
 ...
 * Qualified Name:     org.spongycastle.crypto.digests.SHA224Digest
