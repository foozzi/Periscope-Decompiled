  ...
  implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener
{
  ...
  void dismissInternal(boolean paramBoolean)
  {
    ...
    ᐨ localᐨ = getFragmentManager().ˋ();
    localᐨ.ˊ(this);
    if (paramBoolean)
    {
      localᐨ.commitAllowingStateLoss();
      return;
    }
    localᐨ.commit();
  }
  ...
  public int show(ᐨ paramᐨ, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    paramᐨ.ˊ(this, paramString);
    this.mViewDestroyed = false;
    this.mBackStackId = paramᐨ.commit();
