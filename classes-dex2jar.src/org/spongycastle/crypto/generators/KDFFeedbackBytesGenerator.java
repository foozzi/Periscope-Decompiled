  ...
  implements MacDerivationFunction
{
  ...
  {
    if (this.aMV == 0) {
      this.aMX.update(this.iv, 0, this.iv.length);
    } else {
      this.aMX.update(this.aNd, 0, this.aNd.length);
    }
    if (this.aNf)
    {
 ...
 * Qualified Name:     org.spongycastle.crypto.generators.KDFFeedbackBytesGenerator
