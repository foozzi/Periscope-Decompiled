  ...
  implements BlockCipher
{
  ...
  {
    int m = this.aIJ ^ paramArrayOfInt[0][0];
    int k = this.aIK ^ paramArrayOfInt[0][1];
    int j = this.aIL ^ paramArrayOfInt[0][2];
    int i = 1;
    for (int n = this.aIM ^ paramArrayOfInt[0][3]; i < this.aIH - 1; n = i4 ^ i3 ^ i2 ^ i1 ^ paramArrayOfInt[n][3])
    {
      i3 = aIF[(m & 0xFF)] ^ ﹸ(aIF[(k >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(j >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(n >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][0];
      i2 = aIF[(k & 0xFF)] ^ ﹸ(aIF[(j >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(n >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(m >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][1];
      i1 = aIF[(j & 0xFF)] ^ ﹸ(aIF[(n >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(m >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(k >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][2];
      i4 = aIF[(n & 0xFF)];
      m = ﹸ(aIF[(m >> 8 & 0xFF)], 24);
      k = ﹸ(aIF[(k >> 16 & 0xFF)], 16);
      j = ﹸ(aIF[(j >> 24 & 0xFF)], 8);
      n = i + 1;
      i = i4 ^ m ^ k ^ j ^ paramArrayOfInt[i][3];
      m = aIF[(i3 & 0xFF)] ^ ﹸ(aIF[(i2 >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(i1 >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(i >> 24 & 0xFF)], 8) ^ paramArrayOfInt[n][0];
      k = aIF[(i2 & 0xFF)] ^ ﹸ(aIF[(i1 >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(i >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(i3 >> 24 & 0xFF)], 8) ^ paramArrayOfInt[n][1];
      j = aIF[(i1 & 0xFF)] ^ ﹸ(aIF[(i >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(i3 >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(i2 >> 24 & 0xFF)], 8) ^ paramArrayOfInt[n][2];
      i4 = aIF[(i & 0xFF)];
      i3 = ﹸ(aIF[(i3 >> 8 & 0xFF)], 24);
      i2 = ﹸ(aIF[(i2 >> 16 & 0xFF)], 16);
      i1 = ﹸ(aIF[(i1 >> 24 & 0xFF)], 8);
      i = n + 1;
    }
    int i1 = aIF[(m & 0xFF)] ^ ﹸ(aIF[(k >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(j >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(n >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][0];
    int i2 = aIF[(k & 0xFF)] ^ ﹸ(aIF[(j >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(n >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(m >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][1];
    int i3 = aIF[(j & 0xFF)] ^ ﹸ(aIF[(n >> 8 & 0xFF)], 24) ^ ﹸ(aIF[(m >> 16 & 0xFF)], 16) ^ ﹸ(aIF[(k >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][2];
    n = aIF[(n & 0xFF)];
    m = ﹸ(aIF[(m >> 8 & 0xFF)], 24);
    k = ﹸ(aIF[(k >> 16 & 0xFF)], 16);
    int i4 = ﹸ(aIF[(j >> 24 & 0xFF)], 8);
    j = i + 1;
    i = n ^ m ^ k ^ i4 ^ paramArrayOfInt[i][3];
  ...
  private void ˋ(int[][] paramArrayOfInt)
  {
    ...
    int i = this.aIH - 1;
    int i4;
    for (int n = this.aIM ^ paramArrayOfInt[this.aIH][3]; i > 1; n = i4 ^ i3 ^ i2 ^ i1 ^ paramArrayOfInt[n][3])
    {
      i1 = aIG[(j & 0xFF)] ^ ﹸ(aIG[(n >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(m >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(k >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][0];
      i2 = aIG[(k & 0xFF)] ^ ﹸ(aIG[(j >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(n >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(m >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][1];
      i3 = aIG[(m & 0xFF)] ^ ﹸ(aIG[(k >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(j >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(n >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][2];
      i4 = aIG[(n & 0xFF)];
      m = ﹸ(aIG[(m >> 8 & 0xFF)], 24);
      k = ﹸ(aIG[(k >> 16 & 0xFF)], 16);
      j = ﹸ(aIG[(j >> 24 & 0xFF)], 8);
      n = i - 1;
      i = i4 ^ m ^ k ^ j ^ paramArrayOfInt[i][3];
      j = aIG[(i1 & 0xFF)] ^ ﹸ(aIG[(i >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(i3 >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(i2 >> 24 & 0xFF)], 8) ^ paramArrayOfInt[n][0];
      k = aIG[(i2 & 0xFF)] ^ ﹸ(aIG[(i1 >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(i >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(i3 >> 24 & 0xFF)], 8) ^ paramArrayOfInt[n][1];
      m = aIG[(i3 & 0xFF)] ^ ﹸ(aIG[(i2 >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(i1 >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(i >> 24 & 0xFF)], 8) ^ paramArrayOfInt[n][2];
      i4 = aIG[(i & 0xFF)];
      i3 = ﹸ(aIG[(i3 >> 8 & 0xFF)], 24);
      i2 = ﹸ(aIG[(i2 >> 16 & 0xFF)], 16);
      i1 = ﹸ(aIG[(i1 >> 24 & 0xFF)], 8);
      i = n - 1;
    }
    int i1 = aIG[(j & 0xFF)] ^ ﹸ(aIG[(n >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(m >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(k >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][0];
    int i2 = aIG[(k & 0xFF)] ^ ﹸ(aIG[(j >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(n >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(m >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][1];
    int i3 = aIG[(m & 0xFF)] ^ ﹸ(aIG[(k >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(j >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(n >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][2];
    i = aIG[(n & 0xFF)] ^ ﹸ(aIG[(m >> 8 & 0xFF)], 24) ^ ﹸ(aIG[(k >> 16 & 0xFF)], 16) ^ ﹸ(aIG[(j >> 24 & 0xFF)], 8) ^ paramArrayOfInt[i][3];
