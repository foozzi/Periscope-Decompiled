  ...
  extends BaseKeyFactorySpi
{
  protected PrivateKey engineGeneratePrivate(KeySpec paramKeySpec)
  {
    if ((paramKeySpec instanceof org.spongycastle.jce.spec.ECPrivateKeySpec)) {
      return new BCDSTU4145PrivateKey((org.spongycastle.jce.spec.ECPrivateKeySpec)paramKeySpec);
    }
  ...
  protected PublicKey engineGeneratePublic(KeySpec paramKeySpec)
  {
    if ((paramKeySpec instanceof org.spongycastle.jce.spec.ECPublicKeySpec)) {
      return new BCDSTU4145PublicKey((org.spongycastle.jce.spec.ECPublicKeySpec)paramKeySpec);
    }
  ...
  public PrivateKey ˊ(PrivateKeyInfo paramPrivateKeyInfo)
  {
    ...
    if ((localASN1ObjectIdentifier.equals(UAObjectIdentifiers.awc)) || (localASN1ObjectIdentifier.equals(UAObjectIdentifiers.awd))) {
 ...
 * Qualified Name:     org.spongycastle.jcajce.provider.asymmetric.dstu.KeyFactorySpi
