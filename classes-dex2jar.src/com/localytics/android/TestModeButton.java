  ...
  extends ʼ
{
    ...
    extends Dialog
  {
    ...
    private void createAnimations()
    {
      ...
      this.mAnimOut.setAnimationListener(new TestModeButton.TestModeDialog.2(this));
    }
    ...
    private void setupViews()
    {
      ...
      this.mDialogLayout.setLayoutParams((ViewGroup.LayoutParams)localObject);
      localObject = new Button(getContext(), null);
      ((Button)localObject).setOnClickListener(new TestModeButton.TestModeDialog.1(this));
      this.mDialogLayout.addView((View)localObject);
 ...
 * Qualified Name:     com.localytics.android.TestModeButton
